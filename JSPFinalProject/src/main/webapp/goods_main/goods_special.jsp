...
<div class="body">
    ...
    <div style="width:100%">
      <div style="text-align: center">
        <a href="../goods_main/goods_special.do?page=${curpage>1?curpage-1:curpage }">이전</a>&nbsp;
        ${curpage } page / ${totalpage } pages &nbsp;
        <a href="../goods_main/goods_special.do?page=${curpage<totalpage?curpage+1:curpage }">다음</a>
      </div>
    </div>
</div>
</body>
